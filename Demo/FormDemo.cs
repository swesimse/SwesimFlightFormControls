...
namespace Demo
{
    public partial class FormDemo : Form
    {
        ...
        private void timerDemo_Tick(object sender, EventArgs e)
        {
            ...
            tachometerControl1.Rpm += 100;
            if (tachometerControl1.Rpm > tachometerControl1.MaxAllowableRpm)
                tachometerControl1.Rpm = 0;
        ...
        private void FormDemo_KeyDown(object sender, KeyEventArgs e)
        {
